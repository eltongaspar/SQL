...
/*SELECT 'SAIDA' AS TIPO,F2_FILIAL, F2_DOC, F2_CHVNFE, F2_EST FROM SF2010 (NOLOCK) WHERE F2_EMISSAO='20230413' AND D_E_L_E_T_=''
UNION ALL
SELECT 'ENTRADA' AS TIPO,F1_FILIAL, F1_DOC, F1_CHVNFE, F1_EST FROM SF1010 (NOLOCK) WHERE F1_EMISSAO='20230413' AND D_E_L_E_T_='' AND F1_FORMUL='S'
ORDER BY 1,2,3*/