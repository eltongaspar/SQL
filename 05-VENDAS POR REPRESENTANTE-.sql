...
FROM 
	...
	ON A3_FILIAL = SUBSTRING (C5_FILIAL,1,2)
	AND A3_COD = C5_VEND1
	AND SA3.D_E_L_E_T_ = ''

WHERE 
    SD2.D_E_L_E_T_='' AND D2_EMISSAO BETWEEN '20210101' AND '2021231' AND D2_FILIAL='BA01' AND C5_VEND1 IN ('000008','000009','000011')
