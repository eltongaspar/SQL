...
--A=A Processar;P=Processado;C=Cancelado;E=Erro Processamento;Q=Bloq. CQ                                                          
	...
	Case 
		...
		Then 'PJ - PIX '
		When Len(A1_CGC) < 14
		Then 'PF - PIX Não está configurado '
	Else 'Verificar'
	End As PIX_TIPO		
...
From SC5010 SC5 With(Nolock) --PV Cab
	...
	Left Join SC9010 SC9 With(Nolock) --PV IUtens Liberados
...
Group By
		...
		C5_ZVALPIX,	C5_ZCHVPIX, C5_ZSTSPIX,	C5_OBS, C5_TOTAL,A1_CGC

Order By 1,2,4

--C5_ZSTSPIX
--0=Pendente;1=Ativo;2=Expirado;3=Pago;4=Cancelado;5=Outros                                                                       
